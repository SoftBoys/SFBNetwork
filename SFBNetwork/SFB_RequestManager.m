...
@implementation SFB_RequestManager
...
+ (BTSessionTask *)requestWithUrl:(NSString *)URLString parameters:(id)parameters method:(NSInteger)method success:(SFB_ResponseSuccessBlock)success fail:(SFB_ResponseFailBlock)fail {
...
+ (BTSessionTask *)POST:(NSString *)URLString parameters:(id)parameters bodyFormData:(id<SFB_MultipartFormData>)formData success:(SFB_ResponseSuccessBlock)success fail:(SFB_ResponseFailBlock)fail {
    // 开启转圈圈
    [AFNetworkActivityIndicatorManager sharedManager].enabled = YES;
